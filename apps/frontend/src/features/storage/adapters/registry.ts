 ...
 * Providers without a functional adapter yet (google_drive, onedrive,
 * dropbox, local_folder) fall back to the platform adapter — the UI
 * layer prevents selecting them until their Phase 9b/9c/9d work lands.
 */
